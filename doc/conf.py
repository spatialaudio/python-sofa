...
# -*- coding: utf-8 -*-
#
# python-sofa documentation build configuration file.
#
...
sphinx.SOFA_DOCS_ARE_BEING_BUILT = True
...
#extlinks = {'python-sofa': ('https://sfs.readthedocs.io/en/3.2/%s',
#                    'https://sfs.rtfd.io/')}
